<template>
  <div id="wrapper">
    ...
    <v-row>
      <v-col cols="12" md="6">
        <v-text-field v-model="factory.id" label="Fabrikname*"></v-text-field>
      </v-col>
      <v-col cols="12" md="3">
        <v-text-field
    ...
    <v-row>
      <v-col cols="12" md="4">
        <span
          ><h2>Nodes für die Fabrik</h2>
          <v-btn class="mx-2" icon small color="#333" @click="addNode">
            <v-icon dark> mdi-plus </v-icon> </v-btn
          ><v-btn class="mx-2" icon small color="#333" @click="removeNode">
      ...
      <v-col cols="12" md="4">
        <span
          ><h2>Input der Fabrik</h2>
          <v-btn class="mx-2" icon small color="#333" @click="addInput">
            <v-icon dark> mdi-plus </v-icon> </v-btn
          ><v-btn class="mx-2" icon small color="#333" @click="removeInput">
            <v-icon dark> mdi-minus </v-icon>
          </v-btn></span
        >
        <br /><br />
      ...
      <v-col cols="12" md="4">
        <span
          ><h2>Output der Fabrik</h2>
          <v-btn class="mx-2" icon small color="#333" @click="addOutput">
            <v-icon dark> mdi-plus </v-icon> </v-btn
          ><v-btn class="mx-2" icon small color="#333" @click="removeOutput">
            <v-icon dark> mdi-minus </v-icon>
          </v-btn></span
        >
        <br /><br />
...
export default {
  ...
  methods: {
    showBtnM() {
      if (
        localStorage.getItem("spielstand") !== "" ||
        localStorage.getItem("spielstand") !== undefined
      ) {
        this.showBtn = true;
      }
      this.showBtn = false;
    ...
    writeDB() {
      ...
      if (location.host !== "localhost:8080") {
        prepared = db
          .collection("login")
          .doc(localStorage.getItem("spielstand"));
      } else {
